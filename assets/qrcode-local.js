/* AppQuickUtils local QR encoder - based on Kazuhiko Arase QRCode JS (MIT). */
(function(global){
  const modules={};
...
module.exports = QRCode;
  ...
  function req(name){
    ...
    if(!modules[name]) throw new Error('Módulo QR no encontrado: '+name);
    modules[name](module,module.exports,req);
    return module.exports;
  }
  global.AppQuickUtilsQRCode={QRCode:req('index'),ErrorCorrectLevel:req('QRErrorCorrectLevel')};
})(window);